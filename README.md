...
- [bookstore-cms-rep](#bookstore-cms-rep)
...
<!-- - Click the following url for [... Live Demo ...](https://bookstore-cms-rep-ruby.vercel.app/) -->
...
```sh
  cd bookstore-cms-rep
  git git@github.com:fickryiman/bookstore-cms-rep.git
```
...
Example:
```sh
git@github.com:fickryiman/bookstore-cms-rep.git
```
...
Feel free to check the [https://github.com/fickryiman/bookstore-cms-rep/issues](../../issues/).
